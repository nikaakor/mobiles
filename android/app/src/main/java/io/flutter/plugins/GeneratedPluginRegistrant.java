...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.my_flashlight.MyFlashlightPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin my_flashlight, com.example.my_flashlight.MyFlashlightPlugin", e);
    }
    try {
